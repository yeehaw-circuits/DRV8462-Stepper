// This example shows basic use of a DRV8462 stepper motor driver.
//
...
//   https://pololu.github.io/DRV8462-arduino
...
void setup()
{
  ...
  //
  // This function call assumes that VREF on the DRV8462 has been set to
